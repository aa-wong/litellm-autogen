...
try:
    ...
    from litellm import completion as openai_Completion
...
class Completion(openai_Completion):
    ...
    chat_models = {
        ...
        "gpt-4-0613",
        "gpt-4-32k-0613",
        "command-light", # cohere models
        "command" # cohere models
    }
    ...
    openai_completion_class = not ERROR and litellm.completion
    _total_cost = 0
